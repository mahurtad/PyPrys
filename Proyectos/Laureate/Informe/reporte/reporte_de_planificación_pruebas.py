...
# Ruta donde se guardará el archivo con todos los registros
output_file = r'C:\Users\manue\OneDrive - EduCorpPERU\UPC - Calidad de Software\Proyectos\Pruebas Integrales\reporte_todos_registros.xlsx'

# Guardar el archivo Excel con todos los registros que no tienen estado "Aprobado"
df_filtered[columns_to_select].to_excel(output_file, index=False)
