...
fecha_planificada_max = df_gl1_gl3.groupby(['N° GL', 'N° CP'])['Fecha Planificada'].max().reset_index(name='Fecha Planificada')
...
output_path = os.path.join(os.path.dirname(file_path_new), 'matriz_principal_cps_max_04032025_.xlsx')
