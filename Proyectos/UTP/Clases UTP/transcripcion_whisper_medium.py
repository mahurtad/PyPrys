...
def transcribir_audio_completo(audio_path: str, modelo: str = "medium", idioma: str = "es"):
...
def procesar_video(video_path: str, modelo: str = "medium", idioma: str = "es"):
...
if __name__ == "__main__":
    # RUTA CENTRAL
    base_dir = r"G:\My Drive\UTP\QUIMICA GENERAL"
    ruta_video = os.path.join(base_dir, "QUIMICA GENERAL.mp4")
    modelo_whisper = "medium"  # USO FIJO DEL MODELO MEDIUM
