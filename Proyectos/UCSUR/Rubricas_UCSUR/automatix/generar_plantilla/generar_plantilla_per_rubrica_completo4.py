...
# === CONFIGURACIÓN ===
base_folder_path = r"C:\Users\manue\Downloads\Medicina Veterinaria y Zootecnia - Copy\Tecnología e Industrialización de Alimentos\New folder"  # Cambia esto por tu ruta
error_log = []
validation_log = []
document_log = []
...
def extraer_puntaje_y_descripcion(texto):
    ...
    # Caso 3: Puntaje primero, luego descripción
    ...
    try:
        ...
        for table in doc.tables:
            ...
            if es_formato_dos_filas:
                ...
                # Procesamiento para tablas estándar (1 criterio por fila)
        ...
        # Validación de suma total (20 puntos)
...
def procesar_carpetas():
    for root, dirs, files in os.walk(base_folder_path):
        ...
        for filename in word_files:
            ...
            if df is not None:
                sheet_name = tipo_eval[:31]  # Limitar a 31 caracteres (límite de Excel)
