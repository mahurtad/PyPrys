...
def transcribir_audio(audio_path: str, modelo: str = "large", idioma: str = "es"):
...
if __name__ == "__main__":
    ...
    ruta_audio = os.path.join(base_dir, "grabacion_audio.wav")  # Cambia el nombre del archivo según el que tengas
